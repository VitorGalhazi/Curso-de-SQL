...
<form method="post">
    ...
    <p>Código: <input type="number" name="codlivro"></p>
...
<?php 
    if (isset($_POST["submit"])){
        ...
        $sql="INSERT INTO livro (codlivro, nome, autor, tipo, editora, anoLanc) VALUES ('$codlivro','$nome','$autor','$tipo',$editora,'$anolanc')";
